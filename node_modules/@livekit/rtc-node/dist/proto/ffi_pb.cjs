...
__export(ffi_pb_exports, {
  DisposeCallbackSchema: () => DisposeCallbackSchema,
  DisposeRequestSchema: () => DisposeRequestSchema,
  DisposeResponseSchema: () => DisposeResponseSchema,
  FfiEventSchema: () => FfiEventSchema,
  FfiRequestSchema: () => FfiRequestSchema,
  FfiResponseSchema: () => FfiResponseSchema,
  LogBatchSchema: () => LogBatchSchema,
  LogLevel: () => LogLevel,
...
const LogLevelSchema = /* @__PURE__ */ (0, import_codegenv1.enumDesc)(file_ffi, 0);

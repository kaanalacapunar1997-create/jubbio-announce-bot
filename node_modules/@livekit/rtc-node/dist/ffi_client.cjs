...
class FfiClient extends import_events.default {
  ...
  constructor() {
    ...
    (0, import_native.livekitInitialize)(
      (event_data) => {
        const event = (0, import_protobuf.fromBinary)(import_ffi_pb.FfiEventSchema, event_data);
  ...
  request(req) {
    const request = (0, import_protobuf.create)(import_ffi_pb.FfiRequestSchema, req);
    const req_data = (0, import_protobuf.toBinary)(import_ffi_pb.FfiRequestSchema, request);
    const res_data = (0, import_native.livekitFfiRequest)(req_data);
    return (0, import_protobuf.fromBinary)(import_ffi_pb.FfiResponseSchema, res_data).message.value;
  }
  copyBuffer(ptr, len) {
